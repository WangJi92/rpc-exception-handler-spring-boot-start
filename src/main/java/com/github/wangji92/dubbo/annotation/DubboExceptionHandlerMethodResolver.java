 ...
 * @date 14-05-2021
 */
public class DubboExceptionHandlerMethodResolver {
    /**
    ...
    public static final ReflectionUtils.MethodFilter EXCEPTION_HANDLER_METHODS = method ->
            AnnotatedElementUtils.hasAnnotation(method, DubboExceptionHandler.class);
    ...
    /**
     * A constructor that finds {@link DubboExceptionHandler} methods in the given type.
     *
     * @param handlerType the type to introspect
     */
    public DubboExceptionHandlerMethodResolver(Class<?> handlerType) {
    ...
    private void detectAnnotationExceptionMappings(Method method, List<Class<? extends Throwable>> result) {
        DubboExceptionHandler ann = AnnotatedElementUtils.findMergedAnnotation(method, DubboExceptionHandler.class);
